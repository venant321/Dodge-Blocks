...
function update() {
    ...
    function setupControls() {
        ...
        function addControlListeners(button, key) {
          ...
          events.forEach(e => button.addEventListener(e, () => {
            keysPressed[key] = true;
            e.preventDefault();
          }));
          
          releaseEvents.forEach(e => button.addEventListener(e, () => {
  ...
  if (keysPressed['a'] || keysPressed['arrowleft'] || document.getElementById("left-btn").onclick) player.x -= player.speed;
  if (keysPressed['d'] || keysPressed['arrowright'] || document.getElementById("right-btn").onclick) player.x += player.speed;
  if (keysPressed['w'] || keysPressed['arrowup']|| document.getElementById("up-btn").onclick) player.y -= player.speed;
  if (keysPressed['s'] || keysPressed['arrowdown']|| document.getElementById("down-btn").onclick) player.y += player.speed;
