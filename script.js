...
function update() {
  ...
  if (keysPressed['a'] || keysPressed['arrowleft'] || document.getElementById("left-btn")) player.x -= player.speed;
  if (keysPressed['d'] || keysPressed['arrowright'] || document.getElementById("right-btn")) player.x += player.speed;
  if (keysPressed['w'] || keysPressed['arrowup']|| document.getElementById("up-btn")) player.y -= player.speed;
  if (keysPressed['s'] || keysPressed['arrowdown']|| document.getElementById("down-btn")) player.y += player.speed;
